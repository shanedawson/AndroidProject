...
public class CaseAssessmentMenu extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		form2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent student = new Intent(CaseAssessmentMenu.this, FormativeCase.class);
		...
		summative.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent student = new Intent(CaseAssessmentMenu.this, SummativeCaseView.class);
				startActivity(student);
